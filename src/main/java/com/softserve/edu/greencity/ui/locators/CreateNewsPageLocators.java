...
public enum CreateNewsPageLocators implements Locator {
    ...
    DATE_FIELD(By.cssSelector("div.date > p:first-child > span")),
    ...
    SOURCE_DESCRIPTION(By.cssSelector("div[formarrayname='tags']+label > input + span")),
    ...
    INVALID_IMAGE_ERROR(By.cssSelector(".dropzone+.warning")),
