...
public enum AddAddressPopupLocators implements Locator {
    ...
    STREET_ALERT_MESSAGE(By.xpath("//*[@id='mat-dialog-2']/app-ubs-add-address-pop-up/form/div[3]/div/app-ubs-input-error/div")),
    DISTRICT_ALERT_MESSAGE(By.xpath("//*[@id='mat-dialog-2']/app-ubs-add-address-pop-up/form/div[2]/div/app-ubs-input-error/div")),
