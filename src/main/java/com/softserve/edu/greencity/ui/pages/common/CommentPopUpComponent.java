...
public class CommentPopUpComponent extends TopPart {
    protected By commentPopUpComponent = By.cssSelector(".cdk-overlay-pane>mat-dialog-container");
    private final By warningTitle = By.cssSelector(".warning-text>div");
    private final By cancelButton = By.cssSelector(".buttons-container>.secondary-global-button");
    private final By confirmButton = By.cssSelector("* app-warning-pop-up > * button.primary-global-button");
