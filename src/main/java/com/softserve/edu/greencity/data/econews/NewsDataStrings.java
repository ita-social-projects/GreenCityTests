...
public enum NewsDataStrings {
    ...
    TITLE_31W ("WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW"),//31 symbol This is exactly 1 row of the title field
            //("WWWWWWWWWWWWWWWWWWWWWWWWW"),
          //31 symbol This is exactly 1 row of the title field
    ...
    CONTENT_LONG_EKO_LAVKA("Мережа магазинів спеціалізованих на реалізації натуральної та екологічно чистої продукції, " +
            ...
            "постійні делікатеси, європейські сири, хліб, бакалія, грузинські продукти, солодощі, " +
