...
public class ErrorAssertions {
    ...
    public static void errorEquals(Response error, PairErrorMessage expected) {
        SoftAssert softAssert = new SoftAssert();
        PairErrorMessage actual = error.as(PairErrorMessage.class);
    ...
    public static void arrayEquals(Response array, List<PairErrorMessage> expected) {
        SoftAssert softAssert = new SoftAssert();
        List<PairErrorMessage> actual = array.jsonPath().getList("$", PairErrorMessage.class);
